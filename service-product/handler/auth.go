...
import (
	...
	"github.com/riandigitalent/Digitalent-Kominfo_Pendalaman-Rest-API/service-product/config"
	"github.com/riandigitalent/Digitalent-Kominfo_Pendalaman-Rest-API/service-product/entity"
...
func (auth *AuthMiddleware) ValidateAuthadmin(nextHandler http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if authResult.Data.Role != 0 {
			...
			utils.WrapAPIError(w, r, errors.Errorf("Not autorize").Error(), http.StatusBadRequest)
			return
		}
